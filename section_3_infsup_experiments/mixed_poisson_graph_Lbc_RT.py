# Here the main idea is to use instead of DG1 a different "generalization"
# of the RaviartThomas space
...
def get_system(mesh, f, p0):
    ...
    '''
    V = VectorFunctionSpace(mesh, 'DG', 0, 2)
    ...
    us, p, lm = map(TrialFunction, W)
    vs, q, dlm = map(TestFunction, W)
...
if __name__ == '__main__':
    ...
    for k in range(4, 10):
        ...
        uuh, ph, _ = wh
        u0h, u1h = uuh.split(deepcopy=True)
